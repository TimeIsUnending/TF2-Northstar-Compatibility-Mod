...
//NSC Start
global function SetupComboButtonTest
//NSC End
...
void function SetupComboButtonTest( var menu )
{
	...
	//bool isModded = IsNorthstarServer() //Make this work or something NS contributors lol
	//NSC Start
	int nsc_vanilla = GetConVarInt( "nsc_vanilla" )
	print( "[NSC][DEBUG] At SetUpComboButtonTest function, proceeding to if() statements" )

	// this will be the server browser
	if ( nsc_vanilla == 0 )
	{
		print( "[NSC][DEBUG] At Got to first if(nsc_vanilla = 0)" ) //NSC line
	...
	if ( nsc_vanilla == 0 )
	{
		print( "[NSC][DEBUG] At Got to second if(nsc_vanilla = 0)" ) //NSC line
	...
	if ( nsc_vanilla == 0 )
	{
		print( "[NSC][DEBUG] At Got to third if(nsc_vanilla = 0)" ) //NSC line
